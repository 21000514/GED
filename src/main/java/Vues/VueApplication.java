...
public class VueApplication extends JFrame implements Observer {
	...
	public void initComponents() {
		...
		gBCons.gridx = 0;
		gBCons.gridy = 1;
		panelTags.setPreferredSize(new Dimension(LARGEUR / 6, HAUTEUR * 2 / 3));
		panelGlobal.add(panelTags, gBCons);
		gBCons.gridheight = 1;
		gBCons.gridwidth = 3;
		gBCons.gridx = 0;
		gBCons.gridy = 0;
		panelCommandes.setPreferredSize(new Dimension(LARGEUR, HAUTEUR / 12));
		panelGlobal.add(panelCommandes, gBCons);
		gBCons.gridheight = 1;
		gBCons.gridwidth = 1;
		gBCons.gridx = 1;
		gBCons.gridy = 1;
		panelLecture.setPreferredSize(new Dimension(LARGEUR * 2 / 3,
				HAUTEUR * 5 / 12));
		panelGlobal.add(panelLecture, gBCons);
		gBCons.gridx = 1;
		gBCons.gridy = 2;
		panelListe.setPreferredSize(new Dimension(LARGEUR * 2 / 3,
				HAUTEUR * 6 / 12));
		...
		gBCons.gridy = 1;
		panelApercu
				.setPreferredSize(new Dimension(LARGEUR / 6, HAUTEUR * 2 / 3));
